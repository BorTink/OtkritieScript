...
class Rides:
    ...
    def create_rides(cls):
        ...
        cls.cur.execute("""
                ...
                VALUES 
                    ('PROCESSING', '2024-03-07', '09:00:00', '09:30:00', '1234567890', 'app', 'Monday', 'user1', 'group1', 
                     ...
                     15, 'Work', 100),
                    ('PROCESSING', '2024-03-08', '10:00:00', '10:30:00', '2345678901', 'phone', 'Tuesday', 'user2', 'group2', 
                     ...
                     20, 'Meeting', 120),
                    ('PROCESSING', '2024-03-09', '11:00:00', '11:30:00', '3456789012', 'web', 'Wednesday', 'user3', 'group3', 
                     ...
                     25, 'Shopping', 140),
                    ('PROCESSING', '2024-03-10', '12:00:00', '12:30:00', '4567890123', 'app', 'Thursday', 'user4', 'group4', 
                    ...
                    ('PROCESSING', '2024-03-11', '13:00:00', '13:30:00', '5678901234', 'phone', 'Friday', 'user5', 'group5', 
                     ...
                     35, 'Other', 180),
                    ('PROCESSING', '2024-03-12', '14:00:00', '14:30:00', '6789012345', 'web', 'Saturday', 'user6', 'group6', 
                     ...
                     40, 'Vacation', 200),
                    ('PROCESSING', '2024-03-13', '15:00:00', '15:30:00', '7890123456', 'app', 'Sunday', 'user7', 'group7', 
                     ...
                     45, 'Visit', 220),
                    ('PROCESSING', '2024-03-14', '16:00:00', '16:30:00', '8901234567', 'phone', 'Monday', 'user8', 'group8', 
                     ...
                     50, 'Business', 240),
                    ('PROCESSING', '2024-03-15', '17:00:00', '17:30:00', '9012345678', 'web', 'Tuesday', 'user9', 'group9', 
                     ...
                     55, 'Education', 260),
                    ('PROCESSING', '2024-03-16', '18:00:00', '18:30:00', '0123456789', 'app', 'Wednesday', 'user10', 'group10', 
    ...
    def get_rides_for_processing(cls):
        ...
        if rides:
            return [schemas.Ride(**ride) for ride in rides]
        else:
            return []
